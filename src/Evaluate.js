...
function Searchbox(props) {
    return (
        <div>
            Search by User:
                <input type='text' name='useridSearchParam' placeholder='Search by user id' onChange={props.handleChange} value={props.value}/>
        </div>
    );
}
...
function CustomDropbox(props){
    return(
        <div className="drop">
                        Search by Test:<Dropdown className="Dropdown-root" options={props.options} onChange={props._select} value={props.value}/>
            </div>
    )
}
